"""
Vercel Serverless Function: Content Generator
Manual trigger for content generation and review
"""
import os
import sys
import json
...
def handler(request):
    """Main handler for manual content generation"""
    try:
        logger.info("Starting manual content generation")
        ...
        processed_items = []
        for rss_item in rss_items[:3]:  # Limit to 3 items for manual trigger
            try:
                # Score the content
                ...
                processed_items.append({
                    ...
                    'review_reason': content_item.review_reason
                })
        ...
        return {
            'statusCode': 200,
            'body': json.dumps({
                'message': 'Manual content generation completed',
